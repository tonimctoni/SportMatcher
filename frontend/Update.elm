...
update msg model =
  case msg of
    ...
    GetPollReturn (Ok (Just gotten_poll)) -> ({model | title=gotten_poll.title, gotten_questions=gotten_poll.questions, fixed_answers=Array.repeat (Array.length gotten_poll.questions) 0, error=""}, Cmd.none)
